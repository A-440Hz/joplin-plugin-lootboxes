...
const verboseLogs = true; // TODO: can set this to some console value
...
// getAttributedTagId finds the tag with title `attributedKey` or creates a new one
